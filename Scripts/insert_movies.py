...
def delete_existing_records(collection):
    ...
    try:
        ...
        print(f"Deleted {result.deleted_count} existing records from {COLLECTION_NAME} collection.")
    except PyMongoError as e:
        print(f"Error deleting records: {e}")
        sys.exit(1)

def insert_json_files(collection, json_dir):
...
def main():
    ...
    try:
        ...
        insert_json_files(collection, JSON_DIR)
